export const GLOSSARY = [
    {
        ...
        entries: [
            ...
            ['Equipment Slots', 'Weapon, Armor, Tool, and Artifact. Use "Auto-equip Best" to quickly gear up a colonist with the best available items. Salvage unwanted equipment (♻) to recover 50% of crafting materials.'],
    ...
    },
    {
        ...
        entries: [
            ...
            ['Armor', 'Progression: Iron Helm (8% DR) → Leather Vest (10%) → Mana-Weave Robe (15%, +spell) → Iron Chainmail (18%) → Runic Plate (24%) → Void Armor (30%). Leather requires hides from hunting; iron armor needs smelted iron ore.'],
    ...
    },
    {
        ...
        entries: [
            ...
            ['Iron Ore', 'Mine iron deposits (o, brown on map). Smelt into iron at workbench. Found alongside stone in rock formations (~30% of deposits).'],
            ...
            ['Hides', 'Dropped by medium+ animals when hunted (deer, wolf, cow, okapi, tapir). Tan into leather at workbench.'],
    ...
    },
    {
        ...
        entries: [
            ...
            ['Okapi', '(k) Passive. Pack animal when tamed. Yields 3 meat + 3 hides when hunted.'],
            ['Tapir', '(t) Passive. Happiness aura when tamed. Yields 2 meat + 2 hides when hunted.'],
    ...
    },
    {
        ...
        entries: [
            ...
            ['Armor', 'Damage reduction stacks multiplicatively: Iron Helm (8%), Leather Vest (10%), Mana-Weave Robe (15%), Iron Chainmail (18%), Runic Plate (24%), Void Armor (30%).'],
