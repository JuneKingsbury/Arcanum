...
export const ENTITIES = {
    ...
    chicken: { char: 'c', color: '#ddaa44', hp: 15, speed: 0.4, category: 'animal', hostile: false, meatYield: 1, fleeRange: 3, spawnWeight: 10, tameable: true, tamed: { foodToTame: 2, roles: [{ type: 'production', produces: 'eggs', produceRate: 80, produceAmount: 1 }], effects: [] } },
    cow:     { char: 'C', color: '#aa7744', hp: 80, speed: 0.3, category: 'animal', hostile: false, meatYield: 4, hideYield: 3, fleeRange: 4, spawnWeight: 15, tameable: true, tamed: { foodToTame: 4, roles: [{ type: 'production', produces: 'milk', produceRate: 100, produceAmount: 2 }], effects: [] } },
    sheep:   { char: 's', color: '#cccccc', hp: 40, speed: 0.35, category: 'animal', hostile: false, meatYield: 2, fleeRange: 4, spawnWeight: 15, tameable: true, tamed: { foodToTame: 3, roles: [{ type: 'production', produces: 'wool', produceRate: 120, produceAmount: 1 }], effects: [] } },
    okapi:   { char: 'O', color: '#b3562e', hp: 100, speed: 0.8, category: 'animal', hostile: false, meatYield: 5, hideYield: 3, fleeRange: 4, spawnWeight: 5, tameable: true, tamed: { foodToTame: 5, roles: [{ type: 'pack', expeditionSpeedBonus: 0.25 }], effects: [] } },
    tapir:   { char: 't', color: '#f2e6e6', hp: 60, speed: 0.25, category: 'animal', hostile: false, meatYield: 4, hideYield: 2, fleeRange: 4, spawnWeight: 5, tameable: true, tamed: { foodToTame: 3, roles: [], effects: [{ type: 'mood_aura', radius: 4, moodBonus: 5, context: 'aura' }] } },

    // === Summons ===
    familiar: { name: 'Familiar', char: 'f', color: '#9966ff', hp: 40, speed: 0.5, category: 'summon', damage: 8, summonDuration: 80, roles: [{ type: 'guard', guardRadius: 6, patrolRadius: 3 }] },
    ghost:    { name: 'Ghost',    char: 'g', color: '#88ccff', hp: 25, speed: 0.7, category: 'summon', damage: 14, summonDuration: 60, roles: [{ type: 'guard', guardRadius: 8, patrolRadius: 4 }] },
