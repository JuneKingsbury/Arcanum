...
export const COLONIST_CONFIG = {
    ...
    baseAttackCooldown: 3,          // ticks between attacks (weapons can override with attackCooldown)
...
export const RECIPES = {
    ...
    craft_stone_spear: { input: { stone: 2, wood: 1 }, output: { stone_spear: 1 }, skill: 'crafting', ticks: 12, station: 'workbench', category: 'Weapons' },
    craft_wooden_club: { input: { wood: 2, planks: 1 }, output: { wooden_club: 1 }, skill: 'crafting', ticks: 15, station: 'workbench', category: 'Weapons' },
    craft_hatchet: { input: { planks: 2, stone: 1 }, output: { hatchet: 1 }, skill: 'crafting', ticks: 16, station: 'workbench', category: 'Weapons' },
    craft_iron_sword: { input: { iron: 2, planks: 1 }, output: { iron_sword: 1 }, skill: 'crafting', ticks: 20, station: 'workbench', category: 'Weapons' },
    craft_iron_mace: { input: { iron: 3, planks: 1 }, output: { iron_mace: 1 }, skill: 'crafting', ticks: 24, station: 'workbench', research: 'runecraft', category: 'Weapons' },
    craft_etched_axe: { input: { stone: 2, planks: 1 }, output: { etched_axe: 1 }, skill: 'crafting', ticks: 22, station: 'workbench', research: 'runecraft', category: 'Weapons' },
    craft_enchanted_glaive: { input: { iron: 2, runite: 1, planks: 2 }, output: { enchanted_glaive: 1 }, skill: 'crafting', ticks: 38, station: 'workbench', research: 'mana_weaving', category: 'Weapons' },
    craft_runic_blade: { input: { runite: 2, planks: 1 }, output: { runic_blade: 1 }, skill: 'crafting', ticks: 40, station: 'workbench', research: 'runeforging', category: 'Weapons' },
    craft_runic_greatsword: { input: { runite: 4, iron: 2, planks: 2 }, output: { runic_greatsword: 1 }, skill: 'crafting', ticks: 50, station: 'workbench', research: 'masterwork', category: 'Weapons' },
    craft_void_dagger: { input: { void_essence: 3, runite: 1 }, output: { void_dagger: 1 }, skill: 'crafting', ticks: 45, station: 'workbench', research: 'void_sorcery', category: 'Weapons' },
    craft_void_blade: { input: { void_essence: 6, runite: 2, planks: 1 }, output: { void_blade: 1 }, skill: 'crafting', ticks: 60, station: 'workbench', research: 'void_forging', category: 'Weapons' },
    craft_wool_parka: { input: { wool: 4, leather: 1 }, output: { wool_parka: 1 }, skill: 'crafting', ticks: 16, station: 'workbench', category: 'Armor' },
    craft_iron_brigandine: { input: { iron: 2 }, output: { iron_brigandine: 1 }, skill: 'crafting', ticks: 14, station: 'workbench', category: 'Armor' },
    craft_leather_vest: { input: { leather: 3 }, output: { leather_vest: 1 }, skill: 'crafting', ticks: 18, station: 'workbench', category: 'Armor' },
    craft_iron_chainmail: { input: { iron: 4, leather: 2 }, output: { iron_chainmail: 1 }, skill: 'crafting', ticks: 30, station: 'workbench', category: 'Armor' },
    craft_mana_weave_robe: { input: { runite: 2, leather: 2, iron: 1 }, output: { mana_weave_robe: 1 }, skill: 'crafting', ticks: 40, station: 'workbench', research: 'mana_weaving', category: 'Armor' },
    craft_runic_plate: { input: { runite: 3, iron: 2, leather: 1 }, output: { runic_plate: 1 }, skill: 'crafting', ticks: 45, station: 'workbench', research: 'runeforging', category: 'Armor' },
    craft_void_armor: { input: { void_essence: 5, bricks: 2, planks: 1 }, output: { void_armor: 1 }, skill: 'crafting', ticks: 55, station: 'workbench', research: 'void_forging', category: 'Armor' },
    // Helmets
    craft_wool_cap: { input: { wool: 3 }, output: { wool_cap: 1 }, skill: 'crafting', ticks: 10, station: 'workbench', category: 'Armor' },
    craft_leather_cap: { input: { leather: 2 }, output: { leather_cap: 1 }, skill: 'crafting', ticks: 12, station: 'workbench', category: 'Armor' },
    craft_iron_helmet: { input: { iron: 3 }, output: { iron_helmet: 1 }, skill: 'crafting', ticks: 18, station: 'workbench', category: 'Armor' },
    craft_runic_helm: { input: { runite: 2, iron: 1 }, output: { runic_helm: 1 }, skill: 'crafting', ticks: 35, station: 'workbench', research: 'runeforging', category: 'Armor' },
    craft_void_crown: { input: { void_essence: 4, runite: 1 }, output: { void_crown: 1 }, skill: 'crafting', ticks: 50, station: 'workbench', research: 'void_forging', category: 'Armor' },
    // Pickaxes
    ...
    craft_wooden_wand: { input: { wood: 3, planks: 1 }, output: { wooden_wand: 1 }, skill: 'crafting', ticks: 12, station: 'workbench', research: 'arcane_implements', category: 'Weapons' },
    craft_crystal_staff: { input: { stone: 3, planks: 2, runite: 1 }, output: { crystal_staff: 1 }, skill: 'crafting', ticks: 28, station: 'workbench', research: 'arcane_implements', category: 'Weapons' },
    craft_runic_wand: { input: { runite: 2, planks: 2 }, output: { runic_wand: 1 }, skill: 'crafting', ticks: 35, station: 'workbench', research: 'void_sorcery', category: 'Weapons' },
    craft_void_staff: { input: { void_essence: 5, runite: 2, planks: 2 }, output: { void_staff: 1 }, skill: 'crafting', ticks: 55, station: 'workbench', research: 'void_sorcery', category: 'Weapons' },
    craft_short_bow: { input: { wood: 3, leather: 1 }, output: { short_bow: 1 }, skill: 'crafting', ticks: 14, station: 'workbench', category: 'Weapons' },
    craft_hunting_bow: { input: { planks: 2, leather: 2, iron: 1 }, output: { hunting_bow: 1 }, skill: 'crafting', ticks: 22, station: 'workbench', category: 'Weapons' },
    craft_iron_crossbow: { input: { iron: 3, planks: 2, leather: 1 }, output: { iron_crossbow: 1 }, skill: 'crafting', ticks: 30, station: 'workbench', research: 'marksmanship', category: 'Weapons' },
    craft_runic_crossbow: { input: { runite: 3, iron: 2, planks: 2 }, output: { runic_crossbow: 1 }, skill: 'crafting', ticks: 42, station: 'workbench', research: 'runeforging', category: 'Weapons' },
    craft_void_longbow: { input: { void_essence: 4, runite: 2, planks: 3 }, output: { void_longbow: 1 }, skill: 'crafting', ticks: 55, station: 'workbench', research: 'void_forging', category: 'Weapons' },
...
export const WEAPONS = {
    ...
    stone_spear: { name: 'Stone Spear', damage: 8, tier: 1, description: 'A sharpened stone lashed to a stick.' },
    wooden_club: { name: 'Wooden Club', damage: 10, tier: 1, description: 'A heavy wooden bludgeon.' },
    hatchet: { name: 'Hatchet', damage: 12, tier: 1, choppingSpeed: 1.2, description: 'Good for chopping trees and enemies alike.' },
    iron_sword: { name: 'Iron Sword', damage: 14, tier: 2, description: 'A reliable iron blade.' },
    etched_axe: { name: 'Etched Axe', damage: 15, tier: 2, description: 'An axe inscribed with runes of sharpness.' },
    iron_mace: { name: 'Iron Mace', damage: 16, tier: 2, miningSpeed: 1.2, description: 'A heavy mace that doubles as a mining tool.' },
    enchanted_glaive: { name: 'Enchanted Glaive', damage: 18, tier: 3, spellDamageBonus: 0.25, description: 'A long blade humming with arcane energy.' },
    void_dagger: { name: 'Void Dagger', damage: 20, tier: 3, spellDamageBonus: 0.35, description: 'A dagger forged from void essence. Amplifies spells.' },
    runic_blade: { name: 'Runic Blade', damage: 22, tier: 3, description: 'A blade etched with powerful runes.' },
    runic_greatsword: { name: 'Runic Greatsword', damage: 26, tier: 4, description: 'A massive two-handed runic sword.' },
    wooden_wand: { name: 'Wooden Wand', damage: 3, tier: 1, spellDamageBonus: 0.3, ranged: true, range: 5, projectileChar: '·', projectileColor: '#aaccff', skinKey: 'projectile_spell', description: 'A basic wand for aspiring mages.' },
    crystal_staff: { name: 'Crystal Staff', damage: 8, tier: 2, spellDamageBonus: 0.2, ranged: true, range: 6, projectileChar: '✦', projectileColor: '#88ddff', skinKey: 'projectile_spell', description: 'A staff topped with a focusing crystal.' },
    runic_wand: { name: 'Runic Wand', damage: 5, tier: 3, spellDamageBonus: 0.5, ranged: true, range: 6, projectileChar: '·', projectileColor: '#dd88ff', skinKey: 'projectile_spell', description: 'A wand inscribed with potent spell-amplifying runes.' },
    void_staff: { name: 'Void Staff', damage: 12, tier: 4, spellDamageBonus: 0.4, ranged: true, range: 7, projectileChar: '✦', projectileColor: '#cc00ff', skinKey: 'projectile_spell', description: 'A staff channeling raw void energy.' },
    short_bow: { name: 'Short Bow', damage: 6, tier: 1, ranged: true, range: 5, projectileChar: '-', projectileColor: '#ffaa33', skinKey: 'projectile_arrow', description: 'A simple short-range bow.' },
    hunting_bow: { name: 'Hunting Bow', damage: 9, tier: 2, ranged: true, range: 6, projectileChar: '-', projectileColor: '#ffaa33', skinKey: 'projectile_arrow', description: 'A sturdy bow made for hunting.' },
    iron_crossbow: { name: 'Iron Crossbow', damage: 13, tier: 2, ranged: true, range: 7, projectileChar: '→', projectileColor: '#aaddff', skinKey: 'projectile_bolt', description: 'A mechanical crossbow with iron bolts.' },
    runic_crossbow: { name: 'Runic Crossbow', damage: 17, tier: 3, ranged: true, range: 8, projectileChar: '→', projectileColor: '#bb99ff', skinKey: 'projectile_bolt', description: 'A crossbow enhanced with runic power.' },
    void_longbow: { name: 'Void Longbow', damage: 22, tier: 4, ranged: true, range: 9, projectileChar: '⟶', projectileColor: '#cc00ff', skinKey: 'projectile_void', description: 'A longbow that fires arrows of pure void.' },
    void_blade: { name: 'Void Blade', damage: 30, tier: 4, description: 'The ultimate melee weapon, forged in the void.' },
};

// To add armor: add entry here + a recipe with output: { <key>: 1 }. Auto-detected on craft.
// Any stat can be placed on any equipment type. See README.md "Equipment Stat Reference" for the full list.
export const ARMORS = {
    wool_parka: { name: 'Wool Parka', damageReduction: 0.04, tier: 1, coldResistance: 0.7, hungerReduction: 0.1, description: 'Warm wool parka. Resists cold and reduces hunger.' },
    iron_brigandine: { name: 'Iron Brigandine', damageReduction: 0.08, tier: 1, description: 'Light iron armor offering basic protection.' },
    leather_vest: { name: 'Leather Vest', damageReduction: 0.10, tier: 1, description: 'A sturdy leather vest.' },
    mana_weave_robe: { name: 'Mana-Weave Robe', damageReduction: 0.15, tier: 3, spellDamageBonus: 0.15, description: 'A robe woven with mana threads. Boosts spell damage.' },
    iron_chainmail: { name: 'Iron Chainmail', damageReduction: 0.18, tier: 2, description: 'Interlocking iron rings for solid protection.' },
    runic_plate: { name: 'Runic Plate', damageReduction: 0.24, tier: 3, description: 'Heavy plate armor inscribed with protective runes.' },
    void_armor: { name: 'Void Armor', damageReduction: 0.3, tier: 4, description: 'Armor forged from void essence. Maximum protection.' },
};

// To add a helmet: add entry here + a recipe with output: { <key>: 1 }. Auto-detected on craft.
// Any stat can be placed on any equipment type. See README.md "Equipment Stat Reference" for the full list.
export const HELMETS = {
    wool_cap: { name: 'Wool Cap', damageReduction: 0.02, tier: 1, coldResistance: 0.4, moodBonus: 3, description: 'A cozy wool cap. Keeps spirits and warmth up.' },
    leather_cap: { name: 'Leather Cap', damageReduction: 0.05, tier: 1, description: 'A simple leather skullcap.' },
    iron_helmet: { name: 'Iron Helmet', damageReduction: 0.10, tier: 2, description: 'A solid iron helmet.' },
    runic_helm: { name: 'Runic Helm', damageReduction: 0.14, tier: 3, description: 'A helm etched with protective runes.' },
    void_crown: { name: 'Void Crown', damageReduction: 0.18, tier: 4, spellDamageBonus: 0.10, description: 'A crown of void energy. Boosts spells and protection.' },
};
...
export const TOOLS = {
    ...
    stone_pickaxe: { name: 'Stone Pickaxe', miningSpeed: 1.25, tier: 1, description: 'A basic stone pickaxe for mining.' },
    iron_pickaxe: { name: 'Iron Pickaxe', miningSpeed: 1.45, tier: 2, description: 'An iron pickaxe. Mines faster.' },
    runic_pickaxe: { name: 'Runic Pickaxe', miningSpeed: 1.7, tier: 3, description: 'A pickaxe enhanced with runes. Superior mining.' },
    // Axes — chopping specialist
    stone_axe: { name: 'Stone Axe', choppingSpeed: 1.25, tier: 1, description: 'A basic stone axe for chopping.' },
    iron_axe: { name: 'Iron Axe', choppingSpeed: 1.45, tier: 2, description: 'An iron axe. Chops faster.' },
    runic_axe: { name: 'Runic Axe', choppingSpeed: 1.7, tier: 3, description: 'A runic axe. Superior chopping.' },
    // Sickles — farming specialist
    stone_sickle: { name: 'Stone Sickle', farmingSpeed: 1.25, tier: 1, description: 'A basic stone sickle for farming.' },
    iron_sickle: { name: 'Iron Sickle', farmingSpeed: 1.45, tier: 2, description: 'An iron sickle. Farms faster.' },
    runic_sickle: { name: 'Runic Sickle', farmingSpeed: 1.7, tier: 3, description: 'A runic sickle. Superior farming.' },
    // Hammers — crafting speed specialist
    stone_hammer: { name: 'Stone Hammer', craftingSpeed: 1.25, tier: 1, description: 'A basic stone hammer for crafting.' },
    iron_hammer: { name: 'Iron Hammer', craftingSpeed: 1.45, tier: 2, description: 'An iron hammer. Crafts faster.' },
    runic_hammer: { name: 'Runic Hammer', craftingSpeed: 1.7, tier: 3, description: 'A runic hammer. Superior crafting.' },
    // Mattocks — multi-purpose (mining + chopping, weaker than specialists)
    stone_mattock: { name: 'Stone Mattock', miningSpeed: 1.15, choppingSpeed: 1.15, tier: 1, description: 'A versatile tool for mining and chopping.' },
    iron_mattock: { name: 'Iron Mattock', miningSpeed: 1.3, choppingSpeed: 1.3, tier: 2, description: 'An iron mattock. Good at both mining and chopping.' },
    runic_mattock: { name: 'Runic Mattock', miningSpeed: 1.5, choppingSpeed: 1.5, tier: 3, description: 'A runic mattock. Excellent at mining and chopping.' },
};
...
export const ARTIFACTS = {
    boots_of_haste: { name: 'Boots of Haste', moveSpeedBonus: 0.3, description: 'Enchanted boots that quicken the wearer.' },
    seedkeepers_locket: {
        name: "Seedkeeper's Locket",
        description: 'A locket blessed by druids. Protects crops from blight.',
    ...
    runite_hammer: {
        name: 'Runite Hammer',
        description: 'A hammer pulsing with runic energy. Greatly speeds work.',
        workSpeedBonus: 0.35,
        pedestal: { radius: 5, manaCost: 2, workSpeedBonus: 0.2 },
    },
    staff_of_regrowth: {
        name: 'Staff of Regrowth',
        description: 'A living staff that protects crops and amplifies spells.',
        spellDamageBonus: 0.2,
        pedestal: { radius: 6, manaCost: 2, blightImmunity: true },
    },
    mycelium_crown: {
        name: 'Mycelium Crown',
        description: 'A crown woven from fungal threads. Enhances growth.',
        workSpeedBonus: 0.15,
    ...
    living_bark_armor: {
        ...
        description: 'Armor grown from a living tree. Regenerates the wearer.',
    ...
    dimensional_orb: {
        ...
        description: 'An orb that bends space. Shortens journeys dramatically.',
    ...
    shard_of_oblivion: {
        ...
        description: 'A shard of pure destruction. Devastating but dangerous.',
        expedition: { partyDamageMult: 1.4, trapDamageMult: 1.5 },
        combat: { targetPriority: 5 },
    },
    voidheart: {
        name: 'Voidheart',
        description: 'The heart of the void itself. Ultimate arcane power.',
    ...
    armor_of_the_abyss: {
        ...
        description: 'Abyssal armor that draws fire and shrugs off blows.',
    ...
    amulet_of_fortune: {
        ...
        description: 'A lucky amulet that accelerates learning.',
        pedestal: { radius: 'global', manaCost: 1, skillGrowthBonus: 0.2 },
    },
    merchants_ring: {
        name: "Merchant's Ring",
        description: 'A ring favored by traders. Slightly improves deals.',
...
export const ENTITIES = {
    ...
    // === Golems ===
    farmer_golem:  { name: 'Farmer Golem', char: 'G', color: '#55aa33', hp: 150, speed: 0.3, category: 'golem', roles: [{ type: 'worker', specialty: 'farming', skillLevel: 6 }], cost: { stone: 10, runite: 3, void_essence: 2 }, craftTicks: 80 },
    miner_golem:   { name: 'Miner Golem', char: 'G', color: '#888888', hp: 180, speed: 0.25, category: 'golem', roles: [{ type: 'worker', specialty: 'building', skillLevel: 6 }], cost: { stone: 12, runite: 4, void_essence: 2 }, craftTicks: 90 },
...
export const GOLEM_TYPES = Object.fromEntries(
    Object.entries(ENTITIES).filter(([, e]) => e.category === 'golem').map(([k, e]) => {
        ...
        return [k, { name: e.name, char: e.char, color: e.color, hp: e.hp, speed: e.speed, damage: e.damage, specialty: role.specialty, skillLevel: role.skillLevel, cost: e.cost, craftTicks: e.craftTicks }];
    })
);
...
// Raid system tuning. Used by combat.js.
